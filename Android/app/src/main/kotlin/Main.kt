...
internal val logger: SkipLogger = SkipLogger(subsystem = "my.message.app", category = "MyMessageApp")

private typealias AppRootView = MyMessageAppRootView
private typealias AppDelegate = MyMessageAppAppDelegate
